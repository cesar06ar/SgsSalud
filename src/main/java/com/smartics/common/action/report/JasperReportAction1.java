...
@RequestScoped
public class JasperReportAction1 implements Serializable{
    ...
    private static final Logger LOGGER = Logger.getLogger(JasperReportAction1.class.getName());
